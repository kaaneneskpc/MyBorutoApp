...
fun DetailsContent(
    ...
    LaunchedEffect(key1 = selectedHero) {
        vibrant = colors["vibrant"].orDefault("vibrant")
        darkVibrant = colors["darkVibrant"].orDefault("darkVibrant")
        onDarkVibrant = colors["onDarkVibrant"].orDefault("onDarkVibrant")
    }
